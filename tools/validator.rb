...
descriptor["inputs"].each do |v|
  ...
  # if the "value-choices" key is present, the value must always have specified choices (at least 1), and the default must be in the choices set
  if v.key?("value-choices")
